...
source_skill_id: "anthropics-skills-skills-pdf-skill-md"
category: "Documents, spreadsheets & presentations"
source_mirror: "../../../../../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pdf/SKILL.md"
benchmark_status: "artifact_gated"
---

# pdf

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pdf/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pdf/SKILL.md`
...
- Assigned scenarios: `skill-proof-anthropics-skills-skills-pdf-skill-md`, `documents-spreadsheets-and-presentations-sec-edgar-companyfacts`, `documents-spreadsheets-and-presentations-enron-email`, `documents-spreadsheets-and-presentations-stackoverflow-survey`
