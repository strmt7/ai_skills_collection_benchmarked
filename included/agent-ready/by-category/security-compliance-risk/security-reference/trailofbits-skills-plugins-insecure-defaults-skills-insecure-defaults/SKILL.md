...
source_mirror: "../../../../../skills/by-category/security-compliance-risk/security-reference/trailofbits-skills-plugins-insecure-defaults-skills-insecure-defaults/SKILL.md"
benchmark_status: "artifact_gated"
---

# insecure-defaults

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/security-compliance-risk/security-reference/trailofbits-skills-plugins-insecure-defaults-skills-insecure-defaults/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/security-compliance-risk/security-reference/trailofbits-skills-plugins-insecure-defaults-skills-insecure-defaults/SKILL.md`
...
- Assigned scenarios: `skill-proof-trailofbits-skills-plugins-insecure-defaults-skills-insecure-defaults-skill-md`, `security-compliance-and-risk-owasp-benchmark`, `security-compliance-and-risk-owasp-juice-shop`, `security-compliance-and-risk-kubernetes-examples`
