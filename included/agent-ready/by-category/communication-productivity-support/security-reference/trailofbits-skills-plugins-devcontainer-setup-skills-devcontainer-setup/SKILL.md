...
source_skill_id: "trailofbits-skills-plugins-devcontainer-setup-skills-devcontainer-setup-skill-md"
category: "Communication, productivity & support"
source_mirror: "../../../../../skills/by-category/communication-productivity-support/security-reference/trailofbits-skills-plugins-devcontainer-setup-skills-devcontainer-setup/SKILL.md"
benchmark_status: "artifact_gated"
---

# devcontainer-setup

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/communication-productivity-support/security-reference/trailofbits-skills-plugins-devcontainer-setup-skills-devcontainer-setup/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/communication-productivity-support/security-reference/trailofbits-skills-plugins-devcontainer-setup-skills-devcontainer-setup/SKILL.md`
...
- Assigned scenarios: `skill-proof-trailofbits-skills-plugins-devcontainer-setup-skills-devcontainer-setup-skill-md`, `communication-productivity-and-support-enron-email`, `communication-productivity-and-support-ms-marco`, `communication-productivity-and-support-sec-edgar-companyfacts`
