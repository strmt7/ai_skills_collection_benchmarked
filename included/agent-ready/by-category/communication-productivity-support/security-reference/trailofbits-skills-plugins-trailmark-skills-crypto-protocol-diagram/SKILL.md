...
source_skill_id: "trailofbits-skills-plugins-trailmark-skills-crypto-protocol-diagram-skill-md"
category: "Communication, productivity & support"
source_mirror: "../../../../../skills/by-category/communication-productivity-support/security-reference/trailofbits-skills-plugins-trailmark-skills-crypto-protocol-diagram/SKILL.md"
benchmark_status: "artifact_gated"
---

# crypto-protocol-diagram

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/communication-productivity-support/security-reference/trailofbits-skills-plugins-trailmark-skills-crypto-protocol-diagram/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/communication-productivity-support/security-reference/trailofbits-skills-plugins-trailmark-skills-crypto-protocol-diagram/SKILL.md`
...
- Assigned scenarios: `skill-proof-trailofbits-skills-plugins-trailmark-skills-crypto-protocol-diagram-skill-md`, `communication-productivity-and-support-enron-email`, `communication-productivity-and-support-ms-marco`, `communication-productivity-and-support-sec-edgar-companyfacts`
