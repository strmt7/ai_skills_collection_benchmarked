...
source_skill_id: "composio-community-support-skills-feedback-digest-skill-md"
category: "Communication, productivity & support"
source_mirror: "../../../../../skills/by-category/communication-productivity-support/support-reference/composio-community-support-skills-feedback-digest/SKILL.md"
benchmark_status: "artifact_gated"
---

# feedback-digest

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/communication-productivity-support/support-reference/composio-community-support-skills-feedback-digest/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/communication-productivity-support/support-reference/composio-community-support-skills-feedback-digest/SKILL.md`
...
- Assigned scenarios: `skill-proof-composio-community-support-skills-feedback-digest-skill-md`, `communication-productivity-and-support-enron-email`, `communication-productivity-and-support-ms-marco`, `communication-productivity-and-support-sec-edgar-companyfacts`
