...
source_skill_id: "browser-act-skills-industry-key-contact-radar-api-skill-skill-md"
category: "Communication, productivity & support"
source_mirror: "../../../../../skills/by-category/communication-productivity-support/browser-automation-reference/browser-act-skills-industry-key-contact-radar-api-skill/SKILL.md"
benchmark_status: "artifact_gated"
---

# industry-key-contact-radar-api-skill

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/communication-productivity-support/browser-automation-reference/browser-act-skills-industry-key-contact-radar-api-skill/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/communication-productivity-support/browser-automation-reference/browser-act-skills-industry-key-contact-radar-api-skill/SKILL.md`
...
- Assigned scenarios: `skill-proof-browser-act-skills-industry-key-contact-radar-api-skill-skill-md`, `communication-productivity-and-support-enron-email`, `communication-productivity-and-support-ms-marco`, `communication-productivity-and-support-sec-edgar-companyfacts`
