...
source_skill_id: "k-dense-ai-scientific-agent-skills-scientific-skills-hypogenic-skill-md"
category: "Science, research & data analysis"
source_mirror: "../../../../../skills/by-category/science-research-data-analysis/latest-release-community/k-dense-ai-scientific-agent-skills-scientific-skills-hypogenic/SKILL.md"
benchmark_status: "artifact_gated"
---

# hypogenic

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/science-research-data-analysis/latest-release-community/k-dense-ai-scientific-agent-skills-scientific-skills-hypogenic/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/science-research-data-analysis/latest-release-community/k-dense-ai-scientific-agent-skills-scientific-skills-hypogenic/SKILL.md`
...
- Assigned scenarios: `skill-proof-k-dense-ai-scientific-agent-skills-scientific-skills-hypogenic-skill-md`, `science-research-and-data-analysis-cellxgene-census`, `science-research-and-data-analysis-chembl`, `science-research-and-data-analysis-ome-ngff-samples`
