...
source_mirror: "../../../../../skills/by-category/science-research-data-analysis/latest-release-community/clinical-decision-support/SKILL.md"
benchmark_status: "artifact_gated"
---

# clinical-decision-support

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/science-research-data-analysis/latest-release-community/clinical-decision-support/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/science-research-data-analysis/latest-release-community/clinical-decision-support/SKILL.md`
