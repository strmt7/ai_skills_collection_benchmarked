...
source_skill_id: "strmt7-project-air-defense-agents-skills-ue5-mobile-rendering-skill-md"
category: "Game, mobile & visual QA"
source_mirror: "../../../../../skills/by-category/game-mobile-visual-qa/selected-project-reference/strmt7-project-air-defense-agents-skills-ue5-mobile-rendering/SKILL.md"
benchmark_status: "artifact_gated"
---

# ue5-mobile-rendering

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/game-mobile-visual-qa/selected-project-reference/strmt7-project-air-defense-agents-skills-ue5-mobile-rendering/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/game-mobile-visual-qa/selected-project-reference/strmt7-project-air-defense-agents-skills-ue5-mobile-rendering/SKILL.md`
...
- Assigned scenarios: `skill-proof-strmt7-project-air-defense-agents-skills-ue5-mobile-rendering-skill-md`, `game-mobile-and-visual-qa-air-defense-android-benchmarks`, `game-mobile-and-visual-qa-coco-captions`, `game-mobile-and-visual-qa-owasp-juice-shop`
