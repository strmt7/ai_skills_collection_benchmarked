...
source_mirror: "../../../../../skills/by-category/game-mobile-visual-qa/selected-project-reference/strmt7-project-air-defense-agents-skills-ue5-mobile-ui/SKILL.md"
benchmark_status: "artifact_gated"
---

# ue5-mobile-ui

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/game-mobile-visual-qa/selected-project-reference/strmt7-project-air-defense-agents-skills-ue5-mobile-ui/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/game-mobile-visual-qa/selected-project-reference/strmt7-project-air-defense-agents-skills-ue5-mobile-ui/SKILL.md`
