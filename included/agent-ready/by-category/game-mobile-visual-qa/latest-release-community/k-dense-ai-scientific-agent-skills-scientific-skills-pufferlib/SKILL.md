...
Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/game-mobile-visual-qa/latest-release-community/k-dense-ai-scientific-agent-skills-scientific-skills-pufferlib/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/game-mobile-visual-qa/latest-release-community/k-dense-ai-scientific-agent-skills-scientific-skills-pufferlib/SKILL.md`
...
- Assigned scenarios: `skill-proof-k-dense-ai-scientific-agent-skills-scientific-skills-pufferlib-skill-md`, `game-mobile-and-visual-qa-air-defense-android-benchmarks`, `game-mobile-and-visual-qa-coco-captions`, `game-mobile-and-visual-qa-owasp-juice-shop`
