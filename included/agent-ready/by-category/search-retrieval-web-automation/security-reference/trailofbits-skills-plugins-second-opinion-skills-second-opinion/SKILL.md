...
source_skill_id: "trailofbits-skills-plugins-second-opinion-skills-second-opinion-skill-md"
category: "Search, retrieval & web automation"
source_mirror: "../../../../../skills/by-category/search-retrieval-web-automation/security-reference/trailofbits-skills-plugins-second-opinion-skills-second-opinion/SKILL.md"
benchmark_status: "artifact_gated"
---

# second-opinion

Use this skill when the task matches the description above or the source path clearly applies. Start with this concise entrypoint; open `../../../../../skills/by-category/search-retrieval-web-automation/security-reference/trailofbits-skills-plugins-second-opinion-skills-second-opinion/SKILL.md` only when implementation details, commands, assets, or references are needed.
...
- Source mirror: `../../../../../skills/by-category/search-retrieval-web-automation/security-reference/trailofbits-skills-plugins-second-opinion-skills-second-opinion/SKILL.md`
...
- Assigned scenarios: `skill-proof-trailofbits-skills-plugins-second-opinion-skills-second-opinion-skill-md`, `search-retrieval-and-web-automation-common-crawl-warc`, `search-retrieval-and-web-automation-beir-retrieval`, `search-retrieval-and-web-automation-ms-marco`
