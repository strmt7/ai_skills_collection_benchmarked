...
**After discovery → hand off to preset (unavailable local link target: `../preset/SKILL.md`) or customize (unavailable local link target: `../customize/SKILL.md`) for actual deployment.**
...
Regions/SKUs where `quotaAvailable = 0` should be marked with ❌ in the results. If no region has available quota, hand off to the quota skill (unavailable local link target: `../../../quota/quota.md`) for increase requests and troubleshooting.
...
1. 🚀 **Quick deploy** to top recommendation with defaults → route to preset (unavailable local link target: `../preset/SKILL.md`)
2. ⚙️ **Custom deploy** with version/SKU/capacity/RAI selection → route to customize (unavailable local link target: `../customize/SKILL.md`)
3. 📊 **Check another model** or capacity target → re-run Phase 2
4. ❌ Cancel

### Phase 5: Confirm Project Before Deploying

Before handing off to preset or customize, **always confirm the target project** with the user. See the Project Selection (unavailable local link target: `../SKILL.md#project-selection-all-modes`) rules in the parent router.
...
|-------|-------|------------|
| "No capacity found" | Model not available or all at quota | Hand off to quota skill (unavailable local link target: `../../../quota/quota.md`) for increase requests and troubleshooting |
...
- **preset (unavailable local link target: `../preset/SKILL.md`)** — Quick deployment after capacity discovery
- **customize (unavailable local link target: `../customize/SKILL.md`)** — Custom deployment after capacity discovery
- **quota (unavailable local link target: `../../../quota/quota.md`)** — For quota viewing, increase requests, and troubleshooting quota errors, defer to this skill instead of duplicating guidance
