...
| File | Contents |
|------|----------|
| references/tools.md (unavailable local link target: `references/tools.md`) | Tool integrations |
| references/streaming.md (unavailable local link target: `references/streaming.md`) | Event streaming patterns |
```
...
## Advanced Features
- **Streaming**: See references/streaming.md (unavailable local link target: `references/streaming.md`)
- **Tools**: See references/tools.md (unavailable local link target: `references/tools.md`)
```
