...
|------|-------------|-----------|
| **Preset** | Quick deployment, no customization needed | preset/SKILL.md (unavailable local link target: `preset/SKILL.md`) |
| **Customize** | Full control: version, SKU, capacity, RAI policy | customize/SKILL.md (unavailable local link target: `customize/SKILL.md`) |
| **Capacity Discovery** | Find where you can deploy with specific capacity | capacity/SKILL.md (unavailable local link target: `capacity/SKILL.md`) |
...
> 💡 **Quota management:** For quota increase requests, usage monitoring, and troubleshooting quota errors, defer to the quota skill (unavailable local link target: `../../quota/quota.md`) instead of duplicating that guidance inline.
...
- **preset/SKILL.md (unavailable local link target: `preset/SKILL.md`)** — Quick deployment to optimal region with sensible defaults
- **customize/SKILL.md (unavailable local link target: `customize/SKILL.md`)** — Interactive guided flow with full configuration control
- **capacity/SKILL.md (unavailable local link target: `capacity/SKILL.md`)** — Discover available capacity across regions and projects
