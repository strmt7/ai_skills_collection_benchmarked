...
- When `REPO_URL` is available, link commit hashes: `abc1234 (unavailable local link target: `REPO_URL/commit/abc1234`)` and changed files: `file_path (unavailable local link target: `REPO_URL/blob/BRANCH/file_path`)`
