...
| No quota | All regions show 0 capacity | Defer to the quota skill (unavailable local link target: `../../../quota/quota.md`) for increase requests and troubleshooting; check existing deployments; try alternative models |
...
- **quota (unavailable local link target: `../../../quota/quota.md`)** — For quota viewing, increase requests, and troubleshooting quota errors, defer to this skill
