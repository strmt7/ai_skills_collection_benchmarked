...
|-------|----------|-------------------|------|
| Contributor Guide (unavailable local link target: `./contributor-guide.md`) | New contributors with Python/JS experience | Setup, first PR, codebase patterns | ~30 min |
| Staff Engineer Guide (unavailable local link target: `./staff-engineer-guide.md`) | Staff/principal engineers | Architecture, design decisions, system boundaries | ~45 min |
| Executive Guide (unavailable local link target: `./executive-guide.md`) | VP/directors of engineering | Capabilities, risks, team topology, investment thesis | ~20 min |
| Product Manager Guide (unavailable local link target: `./product-manager-guide.md`) | Product managers | Features, user journeys, constraints, data model | ~20 min |
