...
|-----------|----------|-----------|
| `.sol` | Solidity | {baseDir}/references/solidity.md (unavailable local link target: `{baseDir}/references/solidity.md`) |
| `.vy` | Vyper | {baseDir}/references/vyper.md (unavailable local link target: `{baseDir}/references/vyper.md`) |
| `.rs` + `Cargo.toml` with `solana-program` | Solana (Rust) | {baseDir}/references/solana.md (unavailable local link target: `{baseDir}/references/solana.md`) |
| `.move` + `Move.toml` with `edition` | {baseDir}/references/move-sui.md (unavailable local link target: `{baseDir}/references/move-sui.md`) |
| `.move` + `Move.toml` with `Aptos` | {baseDir}/references/move-aptos.md (unavailable local link target: `{baseDir}/references/move-aptos.md`) |
| `.fc`, `.func`, `.tact` | TON (FunC/Tact) | {baseDir}/references/ton.md (unavailable local link target: `{baseDir}/references/ton.md`) |
| `.rs` + `Cargo.toml` with `cosmwasm-std` | CosmWasm | {baseDir}/references/cosmwasm.md (unavailable local link target: `{baseDir}/references/cosmwasm.md`) |
