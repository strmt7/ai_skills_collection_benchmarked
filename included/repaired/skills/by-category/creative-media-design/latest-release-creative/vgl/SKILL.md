...
> **Related Skill**: Use **bria-ai (unavailable local link target: `../bria-ai/SKILL.md`)** to execute these VGL prompts via the Bria API. VGL defines the structured control format; bria-ai handles generation, editing, and background removal.
...
- **bria-ai (unavailable local link target: `../bria-ai/SKILL.md`)** - API client and endpoint documentation for executing VGL prompts
