...
The main skill context must not add annotations itself. Use the `Task` tool to spawn `dimension-annotator` agents for all anchor-point annotation work. For full examples and annotation format details, see `{baseDir}/references/annotate.md (unavailable local link target: `{baseDir}/references/annotate.md`)`.
...
- `{baseDir}/references/dimension-algebra.md (unavailable local link target: `{baseDir}/references/dimension-algebra.md`)` - Propagator and validator algebra rules
- `{baseDir}/references/common-dimensions.md (unavailable local link target: `{baseDir}/references/common-dimensions.md`)` - Validator vocabulary reference
- `{baseDir}/references/bug-patterns.md (unavailable local link target: `{baseDir}/references/bug-patterns.md`)` - Validator bug-pattern and red-flag reference
- `{baseDir}/references/annotate.md (unavailable local link target: `{baseDir}/references/annotate.md`)` - Annotator format and example reference
