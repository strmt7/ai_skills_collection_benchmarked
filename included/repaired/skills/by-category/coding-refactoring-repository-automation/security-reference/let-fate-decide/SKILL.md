...
4. Interpret the spread using the guide at {baseDir}/references/INTERPRETATION_GUIDE.md (unavailable local link target: `{baseDir}/references/INTERPRETATION_GUIDE.md`)
...
After drawing, read each card's file and synthesize meaning. See {baseDir}/references/INTERPRETATION_GUIDE.md (unavailable local link target: `{baseDir}/references/INTERPRETATION_GUIDE.md`) for the full interpretation workflow.
