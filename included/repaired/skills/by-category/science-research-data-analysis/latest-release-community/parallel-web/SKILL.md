...
When citing academic sources, include author names and publication year where available (e.g., Smith et al., 2025 (unavailable local link target: `url`)) in addition to the standard citation format. If a DOI is present, prefer the DOI link.
