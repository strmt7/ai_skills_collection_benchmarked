...
- Skill page: [varnan-tech-opendirectory-packages-cli-skills-docs-from-code](../skills/by-category/documents-spreadsheets-presentations/reddit-verified-gtm-registry/varnan-tech-opendirectory-packages-cli-skills-docs-from-code.md)
...
- What it covers: Source description: Generates and updates README.md and API reference docs by reading your codebase's functions, routes, types, schemas, and architecture. Uses graphify to build a knowledge graph first, then writes accurate docs from it. Use when asked to write docs, generate a README, document an API, update stale docs, create an API reference from code, add an architecture section, or document a project in any language. Trigger when.
...
- Skill page: [affaan-m-everything-claude-code-agents-skills-frontend-slides](../skills/by-category/documents-spreadsheets-presentations/selected-structure-reference/affaan-m-everything-claude-code-agents-skills-frontend-slides.md)
- Mirrored skill: `included/skills/by-category/documents-spreadsheets-presentations/selected-structure-reference/affaan-m-everything-claude-code-agents-skills-frontend-slides`
- Agent-ready entrypoint: `included/agent-ready/by-category/documents-spreadsheets-presentations/selected-structure-reference/affaan-m-everything-claude-code-agents-skills-frontend-slides/SKILL.md`
...
- What it covers: Source description: Create stunning, animation-rich HTML presentations from scratch or by converting PowerPoint files. Use when the user wants to build a presentation, convert a PPT/PPTX to web, or create slides for a talk/pitch. Helps non-designers discover their aesthetic through visual exploration rather than abstract choices.
- Agent use: Load this skill only when the task matches the source description or path; read SKILL.md first and then load referenced resources on demand.
...
- Skill page: [aizzaku-create-infographics](../skills/by-category/documents-spreadsheets-presentations/creative-reference/aizzaku-create-infographics.md)
...
- Skill page: [anthropics-skills-skills-canvas-design](../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-canvas-design.md)
...
- What it covers: Source description: Create beautiful visual art in .png and .pdf documents using design philosophy. You should use this skill when the user asks to create a poster, piece of art, design, or other static piece. Create original visual designs, never copying existing artists' work to avoid copyright violations.
- Agent use: Load this skill only when the task matches the source description or path; read SKILL.md first and then load referenced resources on demand.
...
- Skill page: [anthropics-skills-skills-docx](../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-docx.md)
...
- Skill page: [anthropics-skills-skills-pdf](../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pdf.md)
...
- Skill page: [anthropics-skills-skills-pptx](../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pptx.md)
- Mirrored skill: `included/skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pptx`
- Agent-ready entrypoint: `included/agent-ready/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-pptx/SKILL.md`
...
- Skill page: [anthropics-skills-skills-theme-factory](../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-theme-factory.md)
...
- Selected ref: `default-branch HEAD`; commit `2c7ec5e78b8e`
- What it covers: Source description: Toolkit for styling artifacts with a theme. These artifacts can be slides, docs, reportings, HTML landing pages, etc. There are 10 pre-set themes with colors/fonts that you can apply to any artifact that has been creating, or can generate a new theme on-the-fly.
- Agent use: Load this skill only when the task matches the source description or path; read SKILL.md first and then load referenced resources on demand.
...
- Skill page: [anthropics-skills-skills-xlsx](../skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-xlsx.md)
- Mirrored skill: `included/skills/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-xlsx`
- Agent-ready entrypoint: `included/agent-ready/by-category/documents-spreadsheets-presentations/official-reference/anthropics-skills-skills-xlsx/SKILL.md`
...
- Skill page: [hugohe3-ppt-master-skills-ppt-master](../skills/by-category/documents-spreadsheets-presentations/latest-release-creative/hugohe3-ppt-master-skills-ppt-master.md)
- Mirrored skill: `included/skills/by-category/documents-spreadsheets-presentations/latest-release-creative/hugohe3-ppt-master-skills-ppt-master`
- Agent-ready entrypoint: `included/agent-ready/by-category/documents-spreadsheets-presentations/latest-release-creative/hugohe3-ppt-master-skills-ppt-master/SKILL.md`
...
- Skill page: [nextlevelbuilder-ui-ux-pro-max-skill-claude-skills-design](../skills/by-category/documents-spreadsheets-presentations/latest-release-creative/nextlevelbuilder-ui-ux-pro-max-skill-claude-skills-design.md)
...
- What it covers: Source description: Comprehensive design skill: brand identity, design tokens, UI styling, logo generation (55 styles, Gemini AI), corporate identity program (50 deliverables, CIP mockups), HTML presentations (Chart.js), banner design (22 styles, social/ads/web/print), icon design (15 styles, SVG, Gemini 3.1 Pro), social photos (HTML→screenshot, multi-platform). Actions: design logo, create CIP, generate mockups, build slides, design.
- Agent use: Load this skill only when the task matches the source description or path; read SKILL.md first and then load referenced resources on demand.
...
- Skill page: [nextlevelbuilder-ui-ux-pro-max-skill-claude-skills-slides](../skills/by-category/documents-spreadsheets-presentations/latest-release-creative/nextlevelbuilder-ui-ux-pro-max-skill-claude-skills-slides.md)
- Mirrored skill: `included/skills/by-category/documents-spreadsheets-presentations/latest-release-creative/nextlevelbuilder-ui-ux-pro-max-skill-claude-skills-slides`
- Agent-ready entrypoint: `included/agent-ready/by-category/documents-spreadsheets-presentations/latest-release-creative/nextlevelbuilder-ui-ux-pro-max-skill-claude-skills-slides/SKILL.md`
...
- Selected ref: `v2.5.0`; commit `07f4ef3ac256`
- What it covers: Source description: Create strategic HTML presentations with Chart.js, design tokens, responsive layouts, copywriting formulas, and contextual slide strategies.
- Agent use: Load this skill only when the task matches the source description or path; read SKILL.md first and then load referenced resources on demand.
